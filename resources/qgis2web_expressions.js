...
function exp_ViikiLandUseOptimization_9rule0_eval_expression(context) {
    // "Management Priority Class" = 'Action needed'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Management Priority Class')  == 'Action needed');
    } else {
        return (feature.get('Management Priority Class')  == 'Action needed');
    }
}
...
function exp_ViikiLandUseOptimization_9rule1_eval_expression(context) {
    // "Management Priority Class" = 'Action advisable'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Management Priority Class')  == 'Action advisable');
    } else {
        return (feature.get('Management Priority Class')  == 'Action advisable');
    }
}
...
function exp_ViikiLandUseOptimization_9rule2_eval_expression(context) {
    // "Management Priority Class" = 'No action needed'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Management Priority Class')  == 'No action needed');
    } else {
        return (feature.get('Management Priority Class')  == 'No action needed');
    }
}