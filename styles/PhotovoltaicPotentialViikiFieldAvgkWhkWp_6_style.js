...
var style_PhotovoltaicPotentialViikiFieldAvgkWhkWp_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Photovoltaic power potential [kWh/ kWp]");
    ...
    if (value >= 2.825015 && value <= 2.842000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.842000 && value <= 2.855000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.855000 && value <= 2.859000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.859000 && value <= 2.865649) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 2.865649 && value <= 2.873000) {
            style = [ new ol.style.Style({
